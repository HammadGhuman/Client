...
import { useApproveRequestMutation, useDeleteRequestMutation, useMissingRequestMutation, usePendingRequestMutation } from '../store/api/authApi';
import { getInfoAsync } from 'expo-file-system';
const ViewMissingPerson = () => {
    const [pendingRequest,{data,error,isSuccess,isLoading}] = useMissingRequestMutation();
...
export default ViewMissingPerson