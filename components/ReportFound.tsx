...
import { useFoundRequestMutation, useReportFoundMutation, useReportMissingMutation } from "../store/api/authApi";

const ReportFound = ({navigation}) => {
  ...
  const [useMissing, { data, isLoading, isSuccess, isError, error }] = useReportFoundMutation()
        ...
        <ScrollView>
          <Box marginY={"5"}>
            <VStack
              ...
              alignItems={"center"}
            >
              <Heading>Report A Found Children</Heading>
            </VStack>
            <VStack space={"4"}>
